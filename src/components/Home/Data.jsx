...
const Data = () => {
  ...
  <div className="home__data">
    <h1 className="home__title">Manish Thapaliya
    <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
    ...
    <p className="home__description">I'm creative Programmer based in chitwan, and I'm very passionate and dedicated to my work</p>
